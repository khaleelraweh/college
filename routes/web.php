...
Route::get('/advertisement-single/{blog?}', [FrontendController::class, 'blog_single'])->name('frontend.advertisement_single'); //section 4
...
Route::get('/faculty-members', [FrontendController::class, 'faculty_members'])->name('frontend.faculty_members');
Route::get('/faculty-member', [FrontendController::class, 'faculty_member'])->name('frontend.faculty_member');
